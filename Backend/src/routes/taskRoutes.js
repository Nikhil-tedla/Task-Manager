...
const { getDashboardData, getUserDashboardData, getTasks, createTask, updateTask, deleteTask, updateTaskStatus, getTaskById } = require('../controllers/TaskControllers');
...
.put("/:id/status",protect,updateTaskStatus)
